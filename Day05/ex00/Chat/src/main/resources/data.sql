...
INSERT INTO chat.messages(room_id, sender, message, time) VALUES
    (1, 2, 'hello world', to_timestamp('2022 Apr', 'YYYY MON')),
    (2, 3, 'hello world', to_timestamp('2022 Apr', 'YYYY MON')),
    (1, 3, 'hello world', to_timestamp('2022 Apr', 'YYYY MON')),
    (2, 1, 'hello world', to_timestamp('2022 Apr', 'YYYY MON')),
    (4, 3, 'hello world', to_timestamp('2022 Apr', 'YYYY MON'));
